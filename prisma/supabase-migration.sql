...
-- Grade table restructure: CA1, CA2, CA3, Exam breakdown
ALTER TABLE "Grade" DROP CONSTRAINT IF EXISTS "Grade_studentId_subjectId_termId_type_key";
ALTER TABLE "Grade" DROP COLUMN IF EXISTS "type";
ALTER TABLE "Grade" DROP COLUMN IF EXISTS "score";
ALTER TABLE "Grade" ADD COLUMN IF NOT EXISTS "ca1" DOUBLE PRECISION DEFAULT 0;
ALTER TABLE "Grade" ADD COLUMN IF NOT EXISTS "ca2" DOUBLE PRECISION DEFAULT 0;
ALTER TABLE "Grade" ADD COLUMN IF NOT EXISTS "ca3" DOUBLE PRECISION DEFAULT 0;
ALTER TABLE "Grade" ADD COLUMN IF NOT EXISTS "exam" DOUBLE PRECISION DEFAULT 0;
ALTER TABLE "Grade" ADD COLUMN IF NOT EXISTS "total" DOUBLE PRECISION DEFAULT 0;
ALTER TABLE "Grade" ADD CONSTRAINT "Grade_studentId_subjectId_termId_key" UNIQUE("studentId", "subjectId", "termId");
