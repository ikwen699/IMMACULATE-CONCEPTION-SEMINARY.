...
export default function PaymentReviewsPage() {
  ...
  if (!['ACCOUNTANT'].includes(role)) return <DashboardLayout><div className="text-center py-12 text-gray-500">Access Denied</div></DashboardLayout>
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-500">Review and forward payments to principal for approval</p>
        </div>
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-200">
              {loading ? (
                ...
                <tr>
                  <td colSpan={7} className="px-6 py-12 text-center text-gray-500">No pending payments to review</td>
                </tr>
              ) : (
          ...
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-white rounded-xl p-6 w-full max-w-lg max-h-[90vh] overflow-y-auto">
              ...
              <div className="flex gap-4 mt-6">
                ...
                <button
                  onClick={() => handleForward(selectedPayment.id)}
                  disabled={actionLoading}
