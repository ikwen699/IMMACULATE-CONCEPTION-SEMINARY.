...
export default function About() {
  return (
    <section id="about" className="relative py-20 sm:py-24 md:py-28 bg-white overflow-hidden">
      <div className="absolute -top-40 right-0 w-96 h-96 bg-blue-50 rounded-full blur-[100px]" />
        ...
        <div className="grid lg:grid-cols-[1.1fr_1fr] gap-10 lg:gap-14 items-center">
          <Reveal>
            <div className="relative">
              <div className="absolute -inset-3 bg-blue-200/40 rounded-3xl rotate-1" />
              <div className="relative rounded-3xl overflow-hidden ring-1 ring-gray-200">
                ...
                <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-blue-950/90 via-blue-950/40 to-transparent p-6 pt-16">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-xl bg-blue-800 text-white flex items-center justify-center font-display font-bold text-sm">
                      Est.
                      <br />
                      1972
                    </div>
              ...
              <ul className="space-y-3">
                {benefits.map((b) => (
                  <li key={b} className="flex items-start gap-3">
                    <span className="mt-1 w-5 h-5 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center shrink-0">
