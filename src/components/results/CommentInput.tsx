...
export default function CommentInput({ value = '', onChange }: CommentInputProps) {
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div className="absolute left-0 top-full mt-1 z-30 w-64 bg-white rounded-xl border border-gray-200 shadow-lg p-3">
          ...
          <div className="flex items-center justify-between mt-2">
            <span className="text-[10px] text-gray-400">{value.length}/160</span>
            <button
              type="button"
